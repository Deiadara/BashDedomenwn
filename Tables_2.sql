...
CREATE TABLE IF NOT EXISTS `Project`.`organization` (
  ...
  `phone1` NUMERIC(10,0) NOT NULL,
  `phone2` NUMERIC(10,0) NOT NULL,
  `phone3` NUMERIC(10,0) NOT NULL,
  `startdate` DATE NOT NULL,
  `orgtype` VARCHAR(20) ,
  `money_other` NUMERIC(10,2) NULL,
  `money_their` NUMERIC(10,2) NULL,
  PRIMARY KEY (`organization_id`),
  CONSTRAINT chk_type CHECK (orgtype IN ('Πανεπιστήμιο', 'Ερευνητικό Κέντρο', 'Εταιρεία'))
  )
ENGINE = InnoDB;
