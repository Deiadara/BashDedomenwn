...
try:
    ...
    if connection.is_connected():
        ...
        works_in_project_generate(proj_num*5,cursor)
        member_generate(10,cursor)
        management_generate(proj_num, cursor)
        scientific_field_generate(20,cursor)
        field_of_project_generate(proj_num*5,cursor)
        evaluates_generate(proj_num*5,cursor)
        deliverable_generate(30,cursor)
